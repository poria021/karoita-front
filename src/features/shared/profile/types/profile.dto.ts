...
/**
 * Profile DTOs — inferred directly from the polymorphic Zod schemas.
 * Prefer these types over hand-written interfaces for form payloads and
 * NestJS request bodies.
 */
