    ...
    <div>
      ...
      >
        <Input
          ...
          placeholder="********"
          className="h-auto rounded-none border-0 bg-transparent px-3.5 py-2.5 pe-10 text-sm font-bold text-slate-800 shadow-none focus-visible:ring-0"
          {...registration}
        />
        <Button
          type="button"
          ...
          className="absolute end-2 text-slate-400 hover:bg-transparent hover:text-slate-600"
        >
