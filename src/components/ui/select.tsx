...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-kv-brand-soft focus:text-kv-brand-soft-fg [&_svg:not([class*='text-'])]:text-kv-text-faint relative flex w-full cursor-pointer items-center gap-2 rounded-kv-control py-1.5 pe-8 ps-2 text-sm outline-hidden select-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
