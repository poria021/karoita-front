...
const alertVariants = cva(
  'relative w-full rounded-kv-panel border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(theme(spacing.5))_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-1 items-start [&>svg]:size-5 [&>svg]:translate-y-0.5 [&>svg]:text-current',
  {
    variants: {
      variant: {
