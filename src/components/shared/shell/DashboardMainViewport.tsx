...
export function DashboardMainViewport({ children }: DashboardMainViewportProps) {
  return (
    <main className="flex min-h-[550px] min-w-0 flex-1 flex-col rounded-none border-y border-x-0 border-kv-border-strong/80 bg-kv-surface p-kv-inset text-start shadow-kv-raised sm:rounded-kv-shell sm:border-x sm:p-kv-page lg:min-h-[calc(100dvh-4rem-2*var(--spacing-kv-group))]">
      <ModulePageHeader />
