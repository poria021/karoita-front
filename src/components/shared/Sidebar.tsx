...
<aside
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 border-b border-slate-100 p-4 lg:hidden">
        ...
        <nav className="flex-1 space-y-1.5 p-4 lg:p-3 lg:pt-5 lg:pb-8">
