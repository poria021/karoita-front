...
export type KvButtonGroupProps = {
  ...
  /** Stretch group to full width; children share space evenly. */
  fullWidth?: boolean;
};
...
/**
 * Shared cluster for adjacent KvButtons (table ops, mobile CTA rows).
 * Owns gap / alignment chrome — features should not invent flex wrappers.
 */
